...
export default function PageHero({ title, eyebrow, description, imageUrl }: PageHeroProps) {
    ...
    return (
      <div className="relative w-full h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center max-w-4xl px-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-display font-bold text-slate-900 mb-8 tracking-tight leading-none">{title}</h1>
  ...
  return (
    <div className="w-full pt-32 pb-16 md:pt-36 md:pb-20 px-6 md:px-12 flex flex-col items-center justify-center text-center bg-transparent relative overflow-hidden min-h-[40vh]">
      <motion.div
      ...
      >
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold text-slate-900 mb-6 tracking-tight leading-[0.95]">{title}</h1>
